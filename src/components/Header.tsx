      ...
      <div className="hidden md:block bg-white border-b border-gray-100 py-2">
        <div className="container mx-auto px-4 lg:px-8 flex justify-between items-center text-[11px] font-medium text-gray-500">
          <div className="flex gap-4">
            <span className="hover:text-blue-600 cursor-pointer">Seller Centre</span>
            <span className="border-l border-gray-200 pl-4 hover:text-blue-600 cursor-pointer">Download App</span>
            <span className="border-l border-gray-200 pl-4">Follow us on Socials</span>
          </div>
          <div className="flex gap-4 items-center">
            ...
            <Link to="/cart" className="flex items-center gap-1 hover:text-blue-600 cursor-pointer">
              <ShoppingCart className="w-3 h-3" /> Cart ({cartCount})
            </Link>
            <span className="font-bold text-gray-900 border-l border-gray-200 pl-4 cursor-pointer">Login / Register</span>
          </div>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="flex h-16 md:h-20 items-center justify-between gap-6">
            ...
            <Link to="/" className="flex items-center gap-0.5">
              <span className="text-2xl font-black tracking-tighter text-blue-600">BOUTIQUE</span>
              <span className="text-2xl font-bold tracking-tighter text-gray-400">MART</span>
            </Link>
            ...
            <div className="flex items-center gap-3">
              ...
              <Link to="/cart" className="flex h-10 w-10 items-center justify-center rounded-full bg-[#F1F5F9] text-gray-600 hover:bg-gray-200 transition relative">
          ...
          <div className="md:hidden pb-4">
            <form onSubmit={handleSearch} className="flex items-center bg-[#F1F5F9] border border-[#E2E8F0] rounded-lg px-3 h-10">
